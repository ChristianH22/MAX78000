...
from PyQt6.QtWidgets import QListWidget, QAbstractButton, QTableWidget
...
class InstrumentPanelViewModel(QObject):
    ...
    vdsSourceChanged = pyqtSignal(str)
    vgsSourceChanged = pyqtSignal(str)
    topologyChanged = pyqtSignal(str)
