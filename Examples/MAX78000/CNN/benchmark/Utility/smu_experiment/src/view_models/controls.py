...
from PySide6.QtWidgets import QLabel, QLineEdit, QPushButton, QWidget, QFileDialog, QSpinBox
...
class ContentControlsViewModel(QObject):
    ...
    def update_sweep_mode_ui(self, sweep_controls_label: QLabel, fixed_source_label:QLabel):
